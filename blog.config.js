...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'throne', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'We3开发者|喜欢一切计算机技术|猫控|任豚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.firstlove.today/', // 网站地址
